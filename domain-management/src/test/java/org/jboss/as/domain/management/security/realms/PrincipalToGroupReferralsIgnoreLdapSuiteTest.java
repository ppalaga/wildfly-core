...
/**
 * A principal to group test to verify that a group that is a referral is ignored rather than causing an error.
 *
 * @author <a href="https://github.com/ppalaga">Peter Palaga</a>
 *
 */
public class PrincipalToGroupReferralsIgnoreLdapSuiteTest extends BaseLdapSuiteTest {
     ...
     */
    @Test
    public void testTestUserSeven() throws Exception {
        verifyGroupMembership(TEST_REALM, "TestUserSeven", "passwordSeven" /* no groups here because ReferralGroupSeven should get ignored */);
    }
